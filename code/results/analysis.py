...
for no in range(1, config["no_instances"]+1):
    ...
    if no % 20 == 0:
        ...
        df.to_csv(f"{config['analysis_name']}/metrics_acc.csv",
                    index_label=["algo","no"])
